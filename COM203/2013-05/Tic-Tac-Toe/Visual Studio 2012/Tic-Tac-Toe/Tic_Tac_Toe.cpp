...
void Tic_Tac_Toe::displayInstructions()
{
	...
	cout << "You are X - the protagonist in the story - you have been chosen by the high " << endl
...
void Tic_Tac_Toe::think(bool easy)
{
	...
	{
		// offensive think -- special cases || win in two
		...
		// offensive think -- main think || win in one
		for (int i = 0; i <= 8; i++)
		{
			switch(i)
			{
		...
		// defensive think -- special cases || block in one
